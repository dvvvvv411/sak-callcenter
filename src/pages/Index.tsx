  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-32 px-6 relative overflow-hidden">
        ...
        <div className="absolute top-20 left-10 w-96 h-96 bg-electric-blue/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 right-10 w-80 h-80 bg-neon-green/5 rounded-full blur-3xl"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-electric-blue/3 to-neon-green/3 rounded-full blur-3xl opacity-30"></div>
        
        <div className="container mx-auto relative z-10">
          <div className="text-center mb-24">
            <div className="inline-flex items-center px-6 py-3 rounded-full bg-gradient-glass backdrop-blur-sm border border-white/20 text-sm font-medium text-primary mb-8 animate-fade-in">
              <Star className="h-4 w-4 mr-2 text-neon-green" />
              Bewährt von 500+ Unternehmen
            </div>
            <h2 className="text-6xl lg:text-7xl font-bold mb-8 text-primary leading-tight animate-fade-in" style={{animationDelay: '0.1s'}}>
          ...
          <div className="grid lg:grid-cols-3 gap-10">
            <Card className="group relative hover:scale-105 transition-all duration-700 bg-gradient-glass backdrop-blur-xl border border-white/20 hover:border-electric-blue/40 shadow-2xl hover:shadow-electric-blue/10 animate-fade-in overflow-hidden" style={{animationDelay: '0.3s'}}>
              ...
              <CardHeader className="text-center pb-8 relative z-10">
                <div className="w-24 h-24 mx-auto mb-8 bg-gradient-primary rounded-3xl flex items-center justify-center group-hover:animate-glow shadow-2xl transform group-hover:rotate-3 transition-transform duration-500">
                  <Headphones className="h-12 w-12 text-white" />
                </div>
                <CardTitle className="text-3xl mb-6 text-primary font-bold">Professionelle Beratung</CardTitle>
              ...
              <CardContent className="relative z-10">
                <ul className="space-y-6">
                  <li className="flex items-center text-base font-medium transform group-hover:translate-x-2 transition-transform duration-300">
                    <div className="w-8 h-8 rounded-full bg-neon-green/20 flex items-center justify-center mr-4">
                      <Check className="h-5 w-5 text-neon-green" />
                    </div>
                    Geschulte Fachkräfte
                  </li>
                  <li className="flex items-center text-base font-medium transform group-hover:translate-x-2 transition-transform duration-300" style={{transitionDelay: '0.1s'}}>
                    <div className="w-8 h-8 rounded-full bg-neon-green/20 flex items-center justify-center mr-4">
                      <Check className="h-5 w-5 text-neon-green" />
                    </div>
                    Mehrsprachige Betreuung
                  </li>
                  <li className="flex items-center text-base font-medium transform group-hover:translate-x-2 transition-transform duration-300" style={{transitionDelay: '0.2s'}}>
                    <div className="w-8 h-8 rounded-full bg-neon-green/20 flex items-center justify-center mr-4">
                      <Check className="h-5 w-5 text-neon-green" />
                    </div>
                    Qualitätskontrolle
            ...
            <Card className="group relative hover:scale-105 transition-all duration-700 bg-gradient-glass backdrop-blur-xl border border-white/20 hover:border-neon-green/40 shadow-2xl hover:shadow-neon-green/10 animate-fade-in overflow-hidden" style={{animationDelay: '0.4s'}}>
              ...
              <CardHeader className="text-center pb-8 relative z-10">
                <div className="w-24 h-24 mx-auto mb-8 bg-gradient-secondary rounded-3xl flex items-center justify-center group-hover:animate-glow shadow-2xl transform group-hover:rotate-3 transition-transform duration-500">
                  <Clock className="h-12 w-12 text-white" />
                </div>
                <CardTitle className="text-3xl mb-6 text-primary font-bold">Erweiterte Erreichbarkeit</CardTitle>
                <CardDescription className="text-lg text-muted-foreground leading-relaxed">
            ...
            <Card className="group relative hover:scale-105 transition-all duration-700 bg-gradient-glass backdrop-blur-xl border border-white/20 hover:border-electric-blue/40 shadow-2xl hover:shadow-electric-blue/10 animate-fade-in overflow-hidden" style={{animationDelay: '0.5s'}}>
              ...
              <CardHeader className="text-center pb-8 relative z-10">
                ...
                <CardTitle className="text-3xl mb-6 text-primary font-bold">Global Reach</CardTitle>
                <CardDescription className="text-lg text-muted-foreground leading-relaxed">
